...
geolocation <- function(id=NULL, local_date=NULL, timestamp=NULL, position=NULL, position_error=NULL, watch_position=NULL, update_now=NULL, high_accuracy=NULL, maximum_age=NULL, timeout=NULL) {
