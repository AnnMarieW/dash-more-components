...
countdown_target_time2 = html.H4(
    [
        ...
        dbc.Badge(
            dmc.Timer(mode="countdown", duration=1000000, timer_format="display"),
            color="danger",
        ),
    ]
)
countdown_target_time_md2 = dcc.Markdown(
    ...
    html.H4(
        [
            "Hurry! Special offer ends in ",
            dbc.Badge(
                dmc.Timer(mode="countdown", duration=100000000, timer_format="display"),
                color="danger",        
            ),            
        ]
    )```"""
...
stopwatch_messages_md = dcc.Markdown(
    ...
    html.H4(
        ...
        class_name="mx-2 mt-4 p-3 border",
    )```"""
)
...
shuttle_md = dcc.Markdown(
    ...
    html.Div(
        [
            dbc.Button("start", id="start", size="lg", color="info", class_name="m-4"),
            html.H1("Space Shuttle Endeavour Countdown"),
            html.H3(
                [
                    dmc.Timer(
        ...
        class_name="mt-4 m-4 border p-4",
    )
    ...
    dbc.ButtonGroup(
        [
            dbc.Button(
                ...
                id="stage" + str(i),
                color="white",
                class_name="m-5 rounded-circle border",
            )
            for i in range(1, 5)
        ],
        size="lg",
