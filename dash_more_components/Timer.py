...
- fire (list of numbers; optional): A list of the time(s) at which to fire a callback.
...
Those keys have the following types:
  - display (boolean; optional): if False, then no timer will be displayed.  Timer `messages` will be displayed (if any).
