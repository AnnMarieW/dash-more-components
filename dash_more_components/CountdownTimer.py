...
- pause (boolean; default True): If True, the counter will no longer update. If False, the timer will resume.
- remaining_duration (number; default 0): remaining time left on countdown timer in seconds"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, starting_duration=Component.UNDEFINED, pause=Component.UNDEFINED, remaining_duration=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'starting_duration', 'pause', 'remaining_duration']
        self._type = 'CountdownTimer'
        self._namespace = 'dash_more_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'starting_duration', 'pause', 'remaining_duration']
