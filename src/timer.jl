...
- `repeat` (Bool; optional): When True, the  timer repeats once it reaches the target.
...
Those elements have the following types:
  - `display` (Bool; optional): if False, then no timer will be displayed.  Timer `messages` will be displayed (if any)  Default: False
